...
// =========================================================================
// SYSTEM TRIGGER HANDLER: Form Submission Validator (AUTO-INVOKED CALLBACK)
// Not an admin operation — fired by the Form's on-submit installable trigger
// and receives the submission event. Lives in Utils as a system callback.
// =========================================================================
